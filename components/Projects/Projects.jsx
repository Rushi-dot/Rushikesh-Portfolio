...
const PROJECTS_DATA = [
  {
    ...
    ctaUrl: 'https://github.com/Rushi-dot/Prediction-Of-Arrhythmia-Using-Deep-Learning',
  ...
  },
  {
    ...
    secondaryUrl: 'https://github.com/Rushi-dot/printerestclone',
    zIndex: 2,
  },
  {
    number: '03',
  ...
  },
  {
    ...
    year: '2025',
    description:
      'Built a full-stack real-time chat application using the MERN stack and Socket.IO, enabling instant messaging, user authentication, and online/offline status tracking.',
    image: '/project-preview-04.png',
    tags: [
      { name: 'react.js', color: 'blue' },
      { name: 'socketIo', color: 'navy' },
      { name: 'Node.js', color: 'blue' },
    ],
    ctaLabel: 'live Demo',
    ctaUrl: 'https://real-time-chat-application-34ck.onrender.com',
    secondaryLabel: 'GitHub',
    secondaryUrl: 'https://github.com/Rushi-dot/Real-time-Chat-Application',
    zIndex: 4,
  },
];
